...
const memePhrases = ["было бы славно", "время начинать план скам", "амогус",
  ...
  "хочу оливье", "боже, я не хочу умирац", "пацаны ваще ребята",
  ...
  "атеисты такие типа", "весело и вкусно", "Ну и где?", "Как тебе такое,\nИлон Маск?",
  "Повар спрашивает повара:\nКакова твоя профессия?", "Какого дьявола\nты здесь шумишь?",
  "Держи,\nтвоя зарплата за апрель!", "Наташ, ты спишь?", "это реально опасно",
  "Вы кто такие?\nЯ вас не звал", "чётко сдох", "никакого праздника",
  "aviasales", "мысли крысиные пошли", "да не бомбит у меня", "язь",
  "Имя Ибрагим\nвам о чём-нибудь говорит?", "загадка дыры", "я вас уничтожу"];
